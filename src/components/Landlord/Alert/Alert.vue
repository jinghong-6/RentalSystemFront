...
import { getAlertByLandlordIdAndAlertId,readAlertByLandlordIdAndAlertId } from '@/api/Alert';
...
function getAlert() {
    ...
    getAlertByLandlordIdAndAlertId(data, token).then(
        res => {
            if (res.status == 200) {
...
function read() {
    ...
    readAlertByLandlordIdAndAlertId(data, token).then(
        res => {
            if (res.status == 200) {
                console.log(res.data)
            }
