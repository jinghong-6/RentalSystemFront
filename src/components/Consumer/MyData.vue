    ...
    <div class="myData">
        <div class="myData-info">
            ...
            <div class="myData-info-items">
                ...
                <div class="myData-info-items-addr">
                    <div class="addr">
...
import { getUserInfoForMyData } from '@/api/Order'
            ...
            res => {
                if (res.status == 200) {
                    if (res.data.data != "500" && res.data.data != '5000') {
                        ...
                        console.log(ReturnImgUrl.value)
...
function setInfo(url) {
    ...
    console.log(data)
    PostChangeConsumerInfo(data, AT).then(
        res => {
            if (res.status == 200) {
                console.log(res.data)
