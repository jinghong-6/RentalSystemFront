<template>
    <div class="RoomCenterBorder">
        <div class="RoomCenter">
            <div class="RoomCenter-title">民宿中心</div>
            ...
            <div class="RoomCenter-room-border">
                <div class="RoomCenter-room">
                    ...
                    <div class="RoomCenter-room-item" v-for="(house, index) in HouseArr" v-if="showFlag">
                        ...
                        <div class="RoomCenter-title-list-land">
                            {{ house.LandlordName }}
                        </div>
...
import { UpdateHouseStatus } from '@/api/Room';
import { getHouseByAdmin,UpdateAdminHouse } from '@/api/Admin';
...
function downHouse(id) {
    ...
    UpdateAdminHouse(data, token).then(
        res => {
            if (res.status == 200) {
                console.log(res.data)
